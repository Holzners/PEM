...
/**
 * Created by olli on 7/1/15.
 */

public class RemoveFactorAdapter extends ArrayAdapter {
    ...
    public RemoveFactorAdapter(MainActivity activity, int resource, HashMap<String,String> factorColors, DateTime date) {
